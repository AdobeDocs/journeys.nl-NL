...
1. Selecteer de reis u wilt melden.
   ...
   Merk op dat u tot uw rapporten kunt ook toegang hebben door **Rapport** te klikken terwijl het bedekken over een reis in de lijst van reizen.
...
1. Het rapport **[!UICONTROL Journey summary]** out-of-the box wordt op het scherm weergegeven. Klik op de knop **[!UICONTROL Close]** om aangepaste rapporten te openen.

   ![](../assets/dynamic_report_journey_12.png)

1. Klik op **[!UICONTROL Create new project]** om een geheel nieuw rapport te maken.
...
Met tabellen met vrije vorm kunt u een tabel maken voor het analyseren van uw gegevens met behulp van de verschillende waarden en afmetingen die beschikbaar zijn in de tabel **[!UICONTROL Component]** .
...
1. Als u meer dan één vrije-vormlijst hebt, kies de beschikbare gegevensbron om in uw grafiek in het **[!UICONTROL Data Source Settings]** venster toe te voegen. Dit venster is ook beschikbaar als u op de gekleurde stip naast de titel voor visualisatie klikt.
...
1. Klik op de knop **[!UICONTROL Visualization]** Instellingen om het grafiektype of de weergave ervan rechtstreeks te wijzigen, zoals:
   ...
   * **[!UICONTROL Percentages]** - De waarden worden weergegeven als een percentage.
   ...
   * **[!UICONTROL Normalization]**: hiermee worden overeenkomende waarden geforceerd.
   * **[!UICONTROL Display Dual Axis]**: voegt een andere as aan de grafiek toe.
   * **[!UICONTROL Limit Max Items]**: beperkt het aantal weergegeven grafieken.
   * **[!UICONTROL Threshold]**: hiermee kunt u een drempelwaarde instellen voor de grafiek. Het wordt weergegeven als een zwarte stippellijn.
