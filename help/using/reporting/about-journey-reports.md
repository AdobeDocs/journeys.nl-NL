...
>[!NOTE]
>
>De component Afleveringsgegevens en segmenten wordt alleen gevuld als u Adobe Campagnestandaard hebt.
...
* **[!UICONTROL Panels]**: Voeg een leeg paneel of een vrije vorm aan uw rapport toe beginnen uw gegevens te filtreren. Raadpleeg de sectie Deelvensters[](../reporting/creating-your-journey-reports.md#adding-panels)toevoegen voor meer informatie hierover
* **[!UICONTROL Visualizations]**: sleep en laat vallen een selectie van visualiseringspunten om uw rapport een grafische dimensie te geven. Raadpleeg voor meer informatie de sectie[Visualisaties](../reporting/creating-your-journey-reports.md#adding-visualizations)toevoegen.
* **[!UICONTROL Components]**: Pas uw rapporten aan met verschillende afmetingen, metriek, segmenten en tijdsperioden. Raadpleeg voor meer informatie de sectie[Componenten](../reporting/creating-your-journey-reports.md#adding-components)toevoegen.
