...
* drie **[!UICONTROL Push]**activiteiten en één**[!UICONTROL Email]** activiteit (met Adobe Campagne Standard)
...
1. Klik **[!UICONTROL Advanced mode]**en definieer de volgende voorwaarde op basis van de velden &quot;timestamp&quot; en &quot;directMarketing.send.value&quot; die afkomstig zijn uit de gegevensbron van het Experience Platform. De syntaxis van de expressie is:
...
1. Klik op de **[!UICONTROL Add a path]**knop en maak een tweede pad voor klanten die de afgelopen 24 uur geen contact hebben gehad en geen loyaliteitslid zijn. Geef het pad de naam &quot;Geen loyaliteitslid&quot;. De syntaxis van de expressie is:
