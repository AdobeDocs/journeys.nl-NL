...
Wanneer de gebeurtenis wordt ontvangen, zal de waarde van de sleutel het systeem toestaan om de persoon te identificeren verbonden aan de gebeurtenis. De sleutel is gekoppeld aan een naamruimte (zie [](../event/selecting-the-namespace.md)) en kan worden gebruikt om query&#39;s uit te voeren op het Adobe Experience Platform. Zie [](../building-journeys/about-orchestration-activities.md).
